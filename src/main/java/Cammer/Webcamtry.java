...
import com.github.sarxos.webcam.Webcam;
public class Webcamtry extends JFrame implements Runnable, WebcamListener, WindowListener, UncaughtExceptionHandler, ItemListener, WebcamDiscoveryListener,Cammer_inderface {
	...
	private static WebcamEvent we=null;
	public void run() {//摄像头display方法
		...
		webcam.addWebcamListener(Webcamtry.this);
	...
	public static void main(String[] args)throws IOException {
		SwingUtilities.invokeLater(new Webcamtry());
