package Demo.soundTest;
        ...
        import javax.sound.sampled.AudioInputStream;//音频输入流，指定格式和长度的输入流

        import javax.sound.sampled.AudioFormat;//声音文件编码

        import javax.sound.sampled.SourceDataLine;//接口提供将音频写入缓冲器的方法
